...
public class AllMapFragment extends Fragment implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    public void onMapReady(GoogleMap googleMap) {
      ...
      //  Query ref = FirebaseDatabase.getInstance().getReference().child("All").orderByChild("test").equalTo("0101");
        Query ref = FirebaseDatabase.getInstance().getReference().child("All");
