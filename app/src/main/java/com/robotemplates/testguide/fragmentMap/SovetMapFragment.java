...
public class SovetMapFragment extends Fragment implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.map_fragment_sovet, container, false);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Query ref = FirebaseDatabase.getInstance().getReference().child("All").orderByChild("idcat").equalTo(2);
